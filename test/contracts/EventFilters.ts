...
import { genRandomSalt, genIdentity, genIdentityCommitment, hashLeftRight, IncrementalQuinTree } from '../../crypto'

import { attestingFee, circuitGlobalStateTreeDepth, epochLength, maxAttesters, maxReputationBudget, maxUsers, numEpochKeyNoncePerEpoch } from '../../config/testLocal'
import { getTreeDepthsForTesting, genEpochKeyCircuitInput, genInputForContract, GSTZERO_VALUE, genReputationCircuitInput, bootstrapRandomUSTree, genProveSignUpCircuitInput, genStartTransitionCircuitInput, genProcessAttestationsCircuitInput, genUserStateTransitionCircuitInput } from '../utils'
import { computeProcessAttestationsProofHash, computeStartTransitionProofHash, deployUnirep, ReputationProof, SignUpProof, UserTransitionProof, Attestation } from '../../core'
...
describe('Attesting', () => {
    ...
    before(async () => {
        ...
        const userStateRoot = genRandomSalt()
